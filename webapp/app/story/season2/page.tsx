...
const episodes = [
  { id: 'jZH9nbaGK7g', title: 'E1 Possum is bigger' },
  { id: 'lF12xUdhJFk', title: 'E2 Getting sorted' },
  { id: 'JMjIqD4As90', title: 'E3 The rainbow' },
  { id: 'pFrFM84pmcQ', title: 'E4 Finding shapes' },
  { id: '7E4wOl76TBc', title: 'E5 Possum goes camping' },
  { id: 'FH0LZ_tYk0U', title: 'E6 Where does milk come from' },
  { id: 'irOoHC1K3jQ', title: 'E7 Where is Possum\'s tree' },
  { id: 'crrq2GzacUs', title: 'E8 Sharing the cookies' },
  { id: 'TLctHlvKPFY', title: 'E9 The great water mystery' },
  { id: 's_XPPZ_RicQ', title: 'E10 The large box' },
  { id: 'oKU3GM2ueAI', title: 'E11 Tell me a story' },
  { id: 'MV46_xmjK8o', title: 'E12 Paper planes' },
  { id: 'qVOx3mpx6SA', title: 'E13 What goes up' },
  { id: 'ZYs2inmFVm8', title: 'E14 Planting a tree' },
  { id: '3Yo09qOU_h4', title: 'E15 The treasure hunt' },
];
      ...
      <div className="max-w-5xl mx-auto mt-4 flex justify-between space-x-10 px-4">
        <Link href="/story/season1">
          <p className="flex items-center space-x-2 cursor-pointer hover:scale-125 active:scale-100 hover:font-bold transition-all duration-100">
            ...
            <span className="text-lg">Back to Season 1</span>
          </p>
        </Link>
        ...
        <Link href="/story/season3">
          <p className="flex items-center space-x-2 cursor-pointer hover:scale-125 active:scale-100 hover:font-bold transition-all duration-100">
            ...
            <span className="text-lg">Go to Season 3</span>
          </p>
        </Link>
      </div>
