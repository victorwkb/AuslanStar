...
//               Practicing in Auslan: Level 1
//             </h1>
//             <p className="text-white font-bold text-xl mt-3">Please show the corresponding Auslan for the letters in the image</p>
//           </div>
//
...
//               <p className="text-lg">
//                 Back to Spelling Page
//               </p>
//             </p>
//           </Link>
//
//           <Link href="/spelling/practice-2">
//             <p className="flex items-center space-x-2 cursor-pointer hover:scale-125 active:scale-100 hover:font-bold transition-all duration-100">
//               <p className="text-lg">
//                 Go to Level 2
